                    ...
                    <form
                        ...
                        <div class="input-group">
                            ...
                            <div class="input-group-append">
                                <button class="btn bg-gradient-info" type="button">
 ...
 <div class="content">
        <div class="row">
                    ...
                    <div class="form-group">
                        <label>Bulan Dibayar</label>
                          <div class="input-group">
                            ...
                            <input type="text" class="form-control" name="bulan_dibayar" autofocus="" required="" />
                          </div>
                      </div>
                      <div class="form-group">
          ...
          <div class="form-group">
                      ...
                      <button type="submit" class="btn btn-fill bg-gradient-info"><i class="fas fa-check"></i></button>
               </div>
                </form>  
