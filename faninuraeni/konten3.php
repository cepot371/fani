        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <div id="content">
                ...
                <nav class="navbar navbar-expand navbar-light bg-white topbar mb-4 static-top shadow">
                  ...
                  <button class="btn btn-gradient-info" type="submit"><i class="fas fa-search fa-fw"></i></button>
                </form>
                    <!-- Topbar Navbar -->
  ...
  <!-- Begin Page Content -->
                <div class="container-fluid">
                    ...
                    <div class="card shadow mb-4">
                        <div class="card-header py-3 btn-gradient-info">
                            <h6 class="m-0 font-weight-bold text-gradient-info"><a href="tambah_pengguna.php">+ &nbsp;Tambah Data Pengguna </a></h6>
                        </div>
                        <div class="card-body">
